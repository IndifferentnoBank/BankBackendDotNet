...
namespace UserSevice.Persistence.Repositories.UserRepository
{
    ...
    {
        Task<User> CreateUserAsync(string name, string email, string phone, string passport, UserRole role, string password);
        Task<User> UpdateUserAsync(Guid userId, string name, string email, string phone, string passport, UserRole role, string password);
